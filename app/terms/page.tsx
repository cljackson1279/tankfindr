      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="p-8 mb-6">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2">
            ...
            <li><strong>Pro Subscriptions:</strong> Recurring access for septic professionals with job history tracking (Starter, Pro, Enterprise tiers)</li>
        ...
        <Card className="p-8 mb-6">
          ...
          <ul className="list-disc list-inside text-gray-700 space-y-2 mb-4">
            <li><strong>Starter ($99/month):</strong> 300 lookups per month</li>
            <li><strong>Pro ($249/month):</strong> 1,500 lookups per month</li>
            <li><strong>Enterprise ($599/month):</strong> Unlimited lookups (subject to fair use policy)</li>
          </ul>
