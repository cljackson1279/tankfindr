...
export const metadata: Metadata = {
  ...
  description: 'Find your septic tank instantly with GPS-accurate locations from government permit records. Access 2.3M+ septic system records across 20 states with transparent data quality labels. Free coverage check. Where is my septic tank? Find out now.',
  keywords: [
  ...
  openGraph: {
    ...
    description: '🎯 Find your septic tank instantly with GPS coordinates from government permit records. 2.3M+ records across 20 states. Free coverage check.',
    type: 'website',
  ...
  twitter: {
    ...
    description: '🎯 GPS-accurate septic tank locations from government records. 2.3M+ records across 20 states.',
