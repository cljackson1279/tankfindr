...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: [
      'Our accuracy depends on the quality of the source data:',
      '• High Quality (90%+ confidence): GPS-surveyed tank locations from county permit records, accurate within 5-15 meters',
      '• Medium Quality (75-85% confidence): Parcel-based or address-based locations, accurate within 30-50 meters',
      'We clearly indicate the confidence level for each result. However, professional verification is always recommended before excavation or construction.',
    ],
  },
  {
    category: 'General',
