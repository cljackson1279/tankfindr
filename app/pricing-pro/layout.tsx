...
export const metadata: Metadata = {
  ...
  description: 'TankFindr Pro pricing for septic companies and contractors. Plans from $79/month. Find septic tanks 10x faster with GPS-accurate locations. 2.5M+ records across 20 states.',
